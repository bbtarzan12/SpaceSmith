...
public:
	...
	// Return value in [0, 1]
	UFUNCTION(BlueprintCallable, Category = "SimplexNoise")
	static float SimplexNoise011D(float x, float inFactor = 1.f);

	UFUNCTION(BlueprintCallable, Category = "SimplexNoise")
	static float SimplexNoise012D(float x, float y, float inFactor = 1.f);

	UFUNCTION(BlueprintCallable, Category = "SimplexNoise")
	static float SimplexNoise013D(float x, float y, float z, float inFactor = 1.f);

	UFUNCTION(BlueprintCallable, Category = "SimplexNoise")
	static float SimplexNoise014D(float x, float y, float z, float w, float inFactor = 1.f);
